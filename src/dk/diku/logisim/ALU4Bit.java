...
public class ALU4Bit extends ManagedComponent
{
    ...
    private static class Factory extends AbstractComponentFactory {
        private Factory() { }
        public String getName() { return "MIPS ALU 4-bit"; }
        public String getDisplayName() { return "ALU 4-bit"; }
        public Component createComponent(Location loc, AttributeSet attrs) { return new ALU4Bit(loc, attrs); }
