...
//		Value c_in = state.getPort(C_IN);
		Value[] outs = Adder.computeSum(dataWidth, a, b);
...
//		painter.drawPort(C_OUT, "c out", Direction.SOUTH);
	...
	static Value[] computeSum(BitWidth width, Value a, Value b) {
